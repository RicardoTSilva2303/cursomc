...
import com.ricardosilva.cursomc.domain.PagamentoComBoleto;
import com.ricardosilva.cursomc.domain.PagamentoComCartao;
import com.ricardosilva.cursomc.domain.Pedido;
import com.ricardosilva.cursomc.domain.Produto;
import com.ricardosilva.cursomc.domain.enums.EstadoPagamento;
import com.ricardosilva.cursomc.domain.enums.Perfil;
...
import com.ricardosilva.cursomc.repositories.ItemPedidoRepository;
import com.ricardosilva.cursomc.repositories.PagamentoRepository;
import com.ricardosilva.cursomc.repositories.PedidoRepository;
import com.ricardosilva.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat10 = new Categoria(null, "Ferramentas");
		Categoria cat11 = new Categoria(null, "Elétrica");
		
		Produto p1 = new Produto(null, "Computador", 2000.00);
		Produto p2 = new Produto(null, "Impressora", 800.00);
		Produto p3 = new Produto(null, "Mouse", 80.00);
		Produto p4 = new Produto(null, "Mesa de escritário", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "silvatricardo@yahoo.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("33392577","31253642"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@yahoo.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33392578","31253643"));
		...
		Pedido ped1 = new Pedido(null, sdf.parse("20/04/2021 16:42"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("20/04/2021 17:09"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, 
				sdf.parse("19/04/2021 00:00:00"),null);
